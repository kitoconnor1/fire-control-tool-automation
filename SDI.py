...
#fuel_recl_table = base + "/inputs/diff_fuel_weight.txt" #This is a table used to reclassify fuels to difficulty weights according to Table 1 of Rodriguez y Silva 2014

#Processed disturbance layer (FDIST) from LANDFIRE - Clump and Eliminate tool applied to raw FDIST layer with minimum patch size = 100 pixels
fuelTreat = base + "/US_FDIST2014/fdist_ClmpElim.tif" #Used to generate fire breaks polygon for mobility index
...
print "Setting non-burnable fules to zero"
sdi_final_out = SDI_path + "/sdi_final.tif"
